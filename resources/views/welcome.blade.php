      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target="_blank" class="btn btn-danger btn-raised btn-lg">
            <i class="fa fa-play"></i> ¿Cómo fuciona?
          </a>
        </div>
      </div>
    </div>
      ...
      <div class="section text-center">
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto">
            ...
            <h5 class="description">Puedes revisar nuestra relación completa de productos, comparar precios y relizar tus pedidos cuando estes seguro.</h5>
          </div>
        </div>
        <div class="features">
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="info">
                ...
                <p>To pedido que realices será confirmado a través de una llamada. Si no confías en los pagos en línea puedes pagar contr entrega el valor acordado.</p>
              </div>
            </div>
            <div class="col-md-4">
              <div class="info">
      ...
      <div class="section section-contacts">
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto">
            ...
            <h4 class="text-center description">Regístrate ingresando tus datos básicos, y podrás realizar tus pedidos a través de nuestro carrito de compras. Si aún no te decides , de todas formas, con tus cuenta de usuario  podrás  hacer todas tus consultas sin compromiso.</h4>
